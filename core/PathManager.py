...
class PathManager(metaclass=PathManagerMeta):
    ...
    def _ensure_initialized(cls) -> None:
        ...
        if not cls._initialized:
            ...
            # Register default paths to ensure standard directories exist.
            cls.register_default_paths()

            cls._initialized = True
            PathManagerMeta._generate_properties(cls)

    @classmethod
    def register_default_paths(cls) -> None:
        """
        Register a set of default paths if they are not already set.
        This includes the 'cache', 'logs', 'templates', 'outputs', 'memory', and 'dreamscape_templates' keys.
        """
        base_dir = cls._paths.get("base", Path.cwd())
        templates_dir = cls._paths.get("templates", base_dir / "templates")
        ...
        default_paths = {
            ...
            "dreamscape_templates": templates_dir / "dreamscape_templates",
        }
