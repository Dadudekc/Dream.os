...
class UnifiedDiscordService:
    ...
    def __init__(
        ...
        config_file: str = "discord_service_config.json",
        ...
        Args:
            ...
            logger_instance: Optional logger instance for DI
            template_env: Optional preconfigured Jinja2 Environment for DI
        """
        # Core state
        ...
        # DI: Logger injection
        self.logger = logger_instance or logging.getLogger("UnifiedDiscordService")
        ...
        # DI: Template environment injection
        if template_env:
        ...
        self._log("UnifiedDiscordService initialized")
