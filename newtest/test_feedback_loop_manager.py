...
from your_module import AletheiaFeedbackLoopManager
...
class TestAletheiaFeedbackLoopManager(unittest.TestCase):
    def setUp(self):
        ...
        patcher1 = patch('your_module.social_config', new=DummySocialConfig())
        self.addCleanup(patcher1.stop)
        self.mock_social_config = patcher1.start()
        
        patcher2 = patch('your_module.write_json_log', new=dummy_write_json_log)
