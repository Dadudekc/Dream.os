...
from chat_mate.interfaces.pyqt.components.prompt_panel import PromptPanel
from chat_mate.interfaces.pyqt.components.logs_panel import LogsPanel
# Adjust relative import path for IngestPanel
from ..components.IngestPanel import IngestPanel
# from .components.IngestPanel import IngestPanel # Old incorrect path
